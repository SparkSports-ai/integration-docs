...
{/* v1: added callback header summary. WHY: the overview previously mentioned only credentials in onboarding, leaving signature and request-id fields hidden in leaf pages. */}
